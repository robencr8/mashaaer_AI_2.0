...
// Import components
import SystemStatus from './ui/components/SystemStatus.js';
...
const App = () => {
  ...
  const {
    configService,
    assistantService
    // Other services are available but not used in this component
  } = useServices();
  ...
  return (
    <div className="app-container">
      ...
      {/* Dev Toggle - Only visible in development mode */}
      <DevToggle />
    </div>
  );
};
